...
const steps = ['Process1 and Steps', 'Process2 and Steps', 'Process3 and Steps', 'Process4 and Steps', 'Review and Update a pipleline'];
...
const PlUpdate = () => {
  ...
  const LoadProcessData = () => {
    ...
    if (activeStep === 0) { setprocessData(process1) }
    else if (activeStep === 1) { setprocessData(process2) }
    else if (activeStep === 2) { setprocessData(process3) }
    else if (activeStep === 3) { setprocessData(process4) }
  };
  const AddProcessData = (field) => (event, value, selectedKey) => {
    ...
    if (selectedKey === 'processData') {
      if (event) {
        ...
        if (activeStep === 0) { setprocess1(data); setbprocess1Updated('true') }
        else if (activeStep === 1) { setprocess2(data); setbprocess1Updated('true') }
        else if (activeStep === 2) { setprocess3(data); setbprocess1Updated('true') }
        else if (activeStep === 3) { setprocess4(data); setbprocess1Updated('true') }
      }
    }
    else if (selectedKey === 'stepsData')
      if (event) {
        data.steps = event;
        if (activeStep === 0) { setprocess1(data); setbsteps1Updated('true') }
        else if (activeStep === 1) { setprocess2(data); setbsteps2Updated('true') }
        else if (activeStep === 2) { setprocess3(data); setbsteps3Updated('true') }
        else if (activeStep === 3) { setprocess4(data); setbsteps4Updated('true') }
      }
          ...
          <Fragment>
            {preOptions && preSteps ?
              <Typography sx={{ mt: 2, mb: 1, py: 1 }}>
                ...
                {activeStep === 0 ? <><AddProcess key={'process1'} LoadProcessData={LoadProcessData} process={process1} AddProcessData={AddProcessData('processData')} preOptions={preOptions} /> <AddSteps key={"process1Steps"} selsteps={process1.steps} AddProcessData={AddProcessData('stepsData')} preSteps={preSteps} /></>
                  : activeStep === 1 ? <><AddProcess key={'process2'} LoadProcessData={LoadProcessData} process={process2} AddProcessData={AddProcessData('processData')} preOptions={preOptions} /> <AddSteps key={"process2Steps"} selsteps={process2.steps} AddProcessData={AddProcessData('stepsData')} preSteps={preSteps} /></>
                    : activeStep === 2 ? <><AddProcess key={'process3'} LoadProcessData={LoadProcessData} process={process3} AddProcessData={AddProcessData('processData')} preOptions={preOptions} /> <AddSteps key={"process3Steps"} selsteps={process3.steps} AddProcessData={AddProcessData('stepsData')} preSteps={preSteps} /></>
                      : activeStep === 3 ? <><AddProcess key={'process4'} LoadProcessData={LoadProcessData} process={process4} AddProcessData={AddProcessData('processData')} preOptions={preOptions} /> <AddSteps key={"process4Steps"} selsteps={process4.steps} AddProcessData={AddProcessData('stepsData')} preSteps={preSteps} /> </>
