import { Card, Fab, Grid, Icon,IconButton,Tooltip, lighten, styled, useTheme,Button, ButtonBase,Select, MenuItem } from '@mui/material';
  ...
  return (
    <Grid container spacing={2} sx={{ mb: 3 }}>
      ...
      <Grid item xs={12} md={9}>
        <Card elevation={3}  sx={{ p: 2 }}>
          <ContentBox>
          <Select xs={12} md={4} sx={{  fontSize:'16px', boxShadow: 'none', '.MuiOutlinedInput-notchedOutline': { border: 0 } }} defaultValue="Destination">
          <MenuItem value="Destination"><Small>Destination1</Small></MenuItem>
          <MenuItem value="Detination2"><Small>Destination2</Small></MenuItem>
        </Select>
        <Select xs={12} md={4} sx={{fontSize:'16px',boxShadow: 'none', '.MuiOutlinedInput-notchedOutline': { border: 0 } }} defaultValue="Status">
          ...
          <Select xs={12} md={4}  sx={{fontSize:'16px',boxShadow: 'none', '.MuiOutlinedInput-notchedOutline': { border: 0 } }} defaultValue="this_month">
